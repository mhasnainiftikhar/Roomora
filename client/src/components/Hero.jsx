...
const Hero = () => {
  return (
    ...
    >
      ...
      <form className="relative z-10 bg-white text-gray-500 rounded-xl p-4 md:p-6 flex flex-col md:flex-row items-stretch md:items-end gap-4 w-full lg:w-fit shadow-2xl">
        ...
        <div className="flex-1">
          ...
          <input list="destinations" id="destinationInput" type="text" className="w-full rounded border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#4989FF]" placeholder="Where are you going?" required />
        ...
        <div>
          ...
          <input id="checkIn" type="date" className="w-full rounded border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#4989FF]" />
        </div>
        ...
        <div>
          ...
          <input id="checkOut" type="date" className="w-full rounded border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#4989FF]" />
        </div>
        ...
        <div>
          ...
          <input min={1} max={10} id="guests" type="number" className="w-full md:w-20 rounded border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#4989FF]" placeholder="1" />
        </div>

        <button className="flex items-center justify-center gap-2 rounded-lg bg-black hover:bg-gray-800 transition-colors py-2.5 px-8 text-white font-medium cursor-pointer h-[42px]">
